        ...
        <div class="card">
            ...
            <form action="./service.php" method="post">
                <div class="input multi">
                    <div class="half">
                        <label for="account_no">Sender : </label>
                        <input type="text" value="<?php echo $acc_dets['account_no']; ?>" id="account_no" disabled>
                    </div>
                    <div class="half">
                        <label for="receiver">Receiver : </label>
                        <input type="text" id="receiver" name="receiver" placeholder="Account No." required>
                    </div>
                </div>
                <div class="input">
                ...
                <div class="input">
                    <label for="init_amt">Amount to Transfer : </label>
                    <input type="text" id="init_amt" name="amt" placeholder="Enter Amount" required>
                </div>
                <input type="text" value="transfer" class="service_choosen" name="service_choosen">
